export default function Home() {
  return (
    <div className='relative'>
      <header className="w-full h-16 flex flex-row  absolute top-0 left-0 z-10">
        <nav className="w-full h-full   flex flex-row justify-between p-4">
          <div className='w-40 h-full hover:cursor-pointer'>
            <svg
              role="img"
              alt="Trello"
              height="36"
          ...
          <div className=' h-full flex flex-row gap-4 text-xl '>
            <button className=' text-blue-500 hover:underline leading-none'>Log in</button>
            <button className=' bg-blue-500 hover:bg-blue-700 text-white px-2 rounded-md leading-none flex justify-center items-center'>
              Sign up
            </button>
          </div>
        </nav>
      </header>
      <main className='h-screen  bg-gradient-to-b from-purple-200 dark:bg-green-500 flex flex-row  items-center '>
        <div className='w-7/12 flex flex-row-reverse pr-52 pl-72 '>
          <div>
            <div className='text-5xl mb-4'>Trello helps teams move work forward.</div>
            <div className='text-2xl mb-10'>Collaborate, manage projects, and reach new productivity peaks. From high rises to the home office, the way your team works is unique—accomplish it all with Trello.</div>
            <div className='flex flex-row w-full gap-2 h-12'>
              <input placeholder="Email" type='text' className='w-7/12 h-full px-4 text-2xl ' />
              <button className='w-5/12 h-full bg-blue-700 text-white text-2xl roundee-md flex justify-center leading-none items-center'>
                sign up-it's free
             </button>
            </div>
          </div>
        ...
        <div className='w-5/12'>
          <img src='https://d2k1ftgv7pobq7.cloudfront.net/meta/p/res/images/spirit/hero/6a3ccd8e5c9a0e8ebea4235d12da6b24/hero.png' alt='some text' className='h-144' />
        </div>
      </main>
    </div>
  )
